...
public final class Constants {
  ...
  public static final class CanConstants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET =33;// -Math.toRadians(0.0);
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET =287 ;//-Math.toRadians(-42);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 318;//-Math.toRadians(0.0);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 166;//-Math.toRadians(-105);
